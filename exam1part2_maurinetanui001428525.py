# -*- coding: utf-8 -*-
"""Exam1Part2-MaurineTanui001428525.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Ju1KwRGAl8r6g7XgXut3uHVWnExCwUge
...
#The plost displays a weak linearity since the scatter plots are widely spread.
...
#Map body styles to numeric
body_style_mapping = {'convertible': 1, 'hatchback': 2, 'sedan': 3, 'wagon': 4, 'hardtop': 5}
df_group_one['body-style'] = df_group_one['body-style'].map(body_style_mapping)
df_group_one
...
#convert to html
!jupyter nbconvert --to html sample_data/Exam1Part2_MaurineTanui001428525.ipynb